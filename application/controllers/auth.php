...
class Auth extends CI_Controller {
	...
	function login()
	{
		...
		else
		{
			...
			$this->_render_page('templates/header_static', $this->data);
			$this->_render_page('login', $this->data);
			$this->_render_page('templates/footer_static', $this->data);
		}
	}
	...
	function create_user()
	{
		...
		else
		{
			...
			//set the flash data error message if there is one
			$this->data['messagec'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('message')));
